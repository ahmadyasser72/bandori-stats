...
export const UserMissionLiveEventRankingResponse = $root.UserMissionLiveEventRankingResponse = (() => {

    /**
     * Properties of a UserMissionLiveEventRankingResponse.
     * @typedef {Object} UserMissionLiveEventRankingResponse.$Properties
     * @property {RankingUserList.$Properties|null} [nearUsers] UserMissionLiveEventRankingResponse nearUsers
     * @property {RankingUserList.$Properties|null} [topUsers] UserMissionLiveEventRankingResponse topUsers
     * @property {RankingUserList.$Properties|null} [borderUsers] UserMissionLiveEventRankingResponse borderUsers
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */

    /**
     * Properties of a UserMissionLiveEventRankingResponse.
     * @exports IUserMissionLiveEventRankingResponse
     * @interface IUserMissionLiveEventRankingResponse
     * @augments UserMissionLiveEventRankingResponse.$Properties
     * @deprecated Use UserMissionLiveEventRankingResponse.$Properties instead.
     */

    /**
     * Shape of a UserMissionLiveEventRankingResponse.
     * @typedef {UserMissionLiveEventRankingResponse.$Properties} UserMissionLiveEventRankingResponse.$Shape
     */

    /**
     * Constructs a new UserMissionLiveEventRankingResponse.
     * @exports UserMissionLiveEventRankingResponse
     * @classdesc Represents a UserMissionLiveEventRankingResponse.
     * @constructor
     * @param {UserMissionLiveEventRankingResponse.$Properties=} [p] Properties to set
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */
    const UserMissionLiveEventRankingResponse = function (p) {
        if (p)
    ...
    /**
     * UserMissionLiveEventRankingResponse nearUsers.
     * @member {RankingUserList.$Properties|null|undefined} nearUsers
     * @memberof UserMissionLiveEventRankingResponse
     * @instance
     */
    UserMissionLiveEventRankingResponse.prototype.nearUsers = null;

    /**
     * UserMissionLiveEventRankingResponse topUsers.
     * @member {RankingUserList.$Properties|null|undefined} topUsers
     * @memberof UserMissionLiveEventRankingResponse
     * @instance
     */
    UserMissionLiveEventRankingResponse.prototype.topUsers = null;

    /**
     * UserMissionLiveEventRankingResponse borderUsers.
     * @member {RankingUserList.$Properties|null|undefined} borderUsers
     * @memberof UserMissionLiveEventRankingResponse
     * @instance
     */
    UserMissionLiveEventRankingResponse.prototype.borderUsers = null;

    /**
     * Decodes a UserMissionLiveEventRankingResponse message from the specified reader or buffer.
     * @function decode
     * @memberof UserMissionLiveEventRankingResponse
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {UserMissionLiveEventRankingResponse & UserMissionLiveEventRankingResponse.$Shape} UserMissionLiveEventRankingResponse
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    UserMissionLiveEventRankingResponse.decode = function (r, l, z, q, g) {
        ...
        var c = l === $undefined ? r.len : r.pos + l, m = g || new $root.UserMissionLiveEventRankingResponse(), v;
        while (r.pos < c) {
            var s = r.pos;
            var t = r.tag();
            if (t === z) {
            ...
            case 3: {
                    if (u !== 2)
                        break;
                    m.borderUsers = $root.RankingUserList.decode(r, r.uint32(), $undefined, q + 1, m.borderUsers);
                    continue;
                }
            }
            r.skipType(u, q, t);
    ...
    return UserMissionLiveEventRankingResponse;
})();
