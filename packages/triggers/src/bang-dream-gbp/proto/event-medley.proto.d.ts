 ...
 */
export interface IUserMedleyEventRankingResponse extends UserMedleyEventRankingResponse.$Properties {
}

/** Represents a UserMedleyEventRankingResponse. */
export class UserMedleyEventRankingResponse {

    /**
     * Constructs a new UserMedleyEventRankingResponse.
     * @param [p] Properties to set
     */
    constructor(p?: UserMedleyEventRankingResponse.$Properties);
     ...
     */
    static decode(r: ($protobuf.Reader|Uint8Array), l?: number): UserMedleyEventRankingResponse & UserMedleyEventRankingResponse.$Shape;
}

export namespace UserMedleyEventRankingResponse {
    ...
    type $Shape = UserMedleyEventRankingResponse.$Properties;
}
