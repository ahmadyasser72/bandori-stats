...
export const UserStoryEventRankingResponse = $root.UserStoryEventRankingResponse = (() => {

    /**
     * Properties of a UserStoryEventRankingResponse.
     * @typedef {Object} UserStoryEventRankingResponse.$Properties
     * @property {RankingUserList.$Properties|null} [nearUsers] UserStoryEventRankingResponse nearUsers
     * @property {RankingUserList.$Properties|null} [topUsers] UserStoryEventRankingResponse topUsers
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */

    /**
     * Properties of a UserStoryEventRankingResponse.
     * @exports IUserStoryEventRankingResponse
     * @interface IUserStoryEventRankingResponse
     * @augments UserStoryEventRankingResponse.$Properties
     * @deprecated Use UserStoryEventRankingResponse.$Properties instead.
     */

    /**
     * Shape of a UserStoryEventRankingResponse.
     * @typedef {UserStoryEventRankingResponse.$Properties} UserStoryEventRankingResponse.$Shape
     */

    /**
     * Constructs a new UserStoryEventRankingResponse.
     * @exports UserStoryEventRankingResponse
     * @classdesc Represents a UserStoryEventRankingResponse.
     * @constructor
     * @param {UserStoryEventRankingResponse.$Properties=} [p] Properties to set
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */
    const UserStoryEventRankingResponse = function (p) {
        if (p)
    ...
    /**
     * UserStoryEventRankingResponse nearUsers.
     * @member {RankingUserList.$Properties|null|undefined} nearUsers
     * @memberof UserStoryEventRankingResponse
     * @instance
     */
    UserStoryEventRankingResponse.prototype.nearUsers = null;

    /**
     * UserStoryEventRankingResponse topUsers.
     * @member {RankingUserList.$Properties|null|undefined} topUsers
     * @memberof UserStoryEventRankingResponse
     * @instance
     */
    UserStoryEventRankingResponse.prototype.topUsers = null;

    /**
     * Decodes a UserStoryEventRankingResponse message from the specified reader or buffer.
     * @function decode
     * @memberof UserStoryEventRankingResponse
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {UserStoryEventRankingResponse & UserStoryEventRankingResponse.$Shape} UserStoryEventRankingResponse
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    UserStoryEventRankingResponse.decode = function (r, l, z, q, g) {
        ...
        var c = l === $undefined ? r.len : r.pos + l, m = g || new $root.UserStoryEventRankingResponse(), v;
        while (r.pos < c) {
            var s = r.pos;
            var t = r.tag();
            if (t === z) {
    ...
    return UserStoryEventRankingResponse;
})();
