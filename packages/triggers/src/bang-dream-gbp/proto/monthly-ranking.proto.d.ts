 ...
 */
export interface IUserMonthlyRankingRankingResponse extends UserMonthlyRankingRankingResponse.$Properties {
}

/** Represents a UserMonthlyRankingRankingResponse. */
export class UserMonthlyRankingRankingResponse {

    /**
     * Constructs a new UserMonthlyRankingRankingResponse.
     * @param [p] Properties to set
     */
    constructor(p?: UserMonthlyRankingRankingResponse.$Properties);

    /** Unknown fields preserved while decoding when enabled */
    $unknowns?: Uint8Array[];

    /** UserMonthlyRankingRankingResponse monthlyRankingPointNearUsers. */
    monthlyRankingPointNearUsers?: (RankingUserList.$Properties|null);

    /** UserMonthlyRankingRankingResponse monthlyRankingPointTopUsers. */
    monthlyRankingPointTopUsers?: (RankingUserList.$Properties|null);

    /** UserMonthlyRankingRankingResponse monthlyRankingPointBorderUsers. */
    monthlyRankingPointBorderUsers?: (RankingUserList.$Properties|null);
     ...
     */
    static decode(r: ($protobuf.Reader|Uint8Array), l?: number): UserMonthlyRankingRankingResponse & UserMonthlyRankingRankingResponse.$Shape;
}

export namespace UserMonthlyRankingRankingResponse {
    ...
    type $Shape = UserMonthlyRankingRankingResponse.$Properties;
}
