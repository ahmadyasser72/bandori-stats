 ...
 */
export interface IUserMissionLiveEventRankingResponse extends UserMissionLiveEventRankingResponse.$Properties {
}

/** Represents a UserMissionLiveEventRankingResponse. */
export class UserMissionLiveEventRankingResponse {

    /**
     * Constructs a new UserMissionLiveEventRankingResponse.
     * @param [p] Properties to set
     */
    constructor(p?: UserMissionLiveEventRankingResponse.$Properties);
    ...
    borderUsers?: (RankingUserList.$Properties|null);
     ...
     */
    static decode(r: ($protobuf.Reader|Uint8Array), l?: number): UserMissionLiveEventRankingResponse & UserMissionLiveEventRankingResponse.$Shape;
}

export namespace UserMissionLiveEventRankingResponse {
    ...
    type $Shape = UserMissionLiveEventRankingResponse.$Properties;
}
