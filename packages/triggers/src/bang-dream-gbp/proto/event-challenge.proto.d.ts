 ...
 */
export interface IUserChallengeEventRankingResponse extends UserChallengeEventRankingResponse.$Properties {
}

/** Represents a UserChallengeEventRankingResponse. */
export class UserChallengeEventRankingResponse {

    /**
     * Constructs a new UserChallengeEventRankingResponse.
     * @param [p] Properties to set
     */
    constructor(p?: UserChallengeEventRankingResponse.$Properties);
    ...
    challengeMusicRankings: UserChallengeMusicRankingResponse.$Properties[];
     ...
     */
    static decode(r: ($protobuf.Reader|Uint8Array), l?: number): UserChallengeEventRankingResponse & UserChallengeEventRankingResponse.$Shape;
}

export namespace UserChallengeEventRankingResponse {
    ...
    interface $Properties {
        ...
        /** UserChallengeEventRankingResponse challengeMusicRankings */
        challengeMusicRankings?: (UserChallengeMusicRankingResponse.$Properties[]|null);
    ...
    type $Shape = UserChallengeEventRankingResponse.$Properties;
}
 ...
 */
export interface IUserChallengeMusicRankingResponse extends UserChallengeMusicRankingResponse.$Properties {
}

/** Represents a UserChallengeMusicRankingResponse. */
export class UserChallengeMusicRankingResponse {

    /**
     * Constructs a new UserChallengeMusicRankingResponse.
     * @param [p] Properties to set
     */
    constructor(p?: UserChallengeMusicRankingResponse.$Properties);
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    static decode(r: ($protobuf.Reader|Uint8Array), l?: number): UserChallengeMusicRankingResponse & UserChallengeMusicRankingResponse.$Shape;
}

export namespace UserChallengeMusicRankingResponse {
    ...
    type $Shape = UserChallengeMusicRankingResponse.$Properties;
}
