...
export const UserVersusEventRankingResponse = $root.UserVersusEventRankingResponse = (() => {

    /**
     * Properties of a UserVersusEventRankingResponse.
     * @typedef {Object} UserVersusEventRankingResponse.$Properties
     * @property {RankingUserList.$Properties|null} [eventPointNearUsers] UserVersusEventRankingResponse eventPointNearUsers
     * @property {RankingUserList.$Properties|null} [eventPointTopUsers] UserVersusEventRankingResponse eventPointTopUsers
     * @property {Array.<UserVersusMusicRankingResponse.$Properties>|null} [versusMusicRankings] UserVersusEventRankingResponse versusMusicRankings
     * @property {RankingUserList.$Properties|null} [eventPointBorderUsers] UserVersusEventRankingResponse eventPointBorderUsers
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */

    /**
     * Properties of a UserVersusEventRankingResponse.
     * @exports IUserVersusEventRankingResponse
     * @interface IUserVersusEventRankingResponse
     * @augments UserVersusEventRankingResponse.$Properties
     * @deprecated Use UserVersusEventRankingResponse.$Properties instead.
     */

    /**
     * Shape of a UserVersusEventRankingResponse.
     * @typedef {UserVersusEventRankingResponse.$Properties} UserVersusEventRankingResponse.$Shape
     */

    /**
     * Constructs a new UserVersusEventRankingResponse.
     * @exports UserVersusEventRankingResponse
     * @classdesc Represents a UserVersusEventRankingResponse.
     * @constructor
     * @param {UserVersusEventRankingResponse.$Properties=} [p] Properties to set
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */
    const UserVersusEventRankingResponse = function (p) {
        this.versusMusicRankings = [];
        if (p)
     ...
     * @memberof UserVersusEventRankingResponse
     * @instance
     */
    UserVersusEventRankingResponse.prototype.eventPointNearUsers = null;
     ...
     * @instance
     */
    UserVersusEventRankingResponse.prototype.eventPointTopUsers = null;

    /**
     * UserVersusEventRankingResponse versusMusicRankings.
     * @member {Array.<UserVersusMusicRankingResponse.$Properties>} versusMusicRankings
     * @memberof UserVersusEventRankingResponse
     * @instance
     */
    UserVersusEventRankingResponse.prototype.versusMusicRankings = $util.emptyArray;
     ...
     * @instance
     */
    UserVersusEventRankingResponse.prototype.eventPointBorderUsers = null;
     ...
     */
    UserVersusEventRankingResponse.decode = function (r, l, z, q, g) {
        ...
        var c = l === $undefined ? r.len : r.pos + l, m = g || new $root.UserVersusEventRankingResponse(), v;
        while (r.pos < c) {
            var s = r.pos;
            var t = r.tag();
            if (t === z) {
            ...
            case 3: {
                    if (u !== 2)
                        break;
                    if (!(m.versusMusicRankings && m.versusMusicRankings.length))
                        m.versusMusicRankings = [];
                    m.versusMusicRankings.push($root.UserVersusMusicRankingResponse.decode(r, r.uint32(), $undefined, q + 1));
                    continue;
                }
            case 4: {
                    if (u !== 2)
    ...
    return UserVersusEventRankingResponse;
})();
...
export const UserVersusMusicRankingResponse = $root.UserVersusMusicRankingResponse = (() => {

    /**
     * Properties of a UserVersusMusicRankingResponse.
     * @typedef {Object} UserVersusMusicRankingResponse.$Properties
     * @property {number|null} [musicId] UserVersusMusicRankingResponse musicId
     * @property {RankingUserList.$Properties|null} [scoreNearUsers] UserVersusMusicRankingResponse scoreNearUsers
     * @property {RankingUserList.$Properties|null} [scoreTopUsers] UserVersusMusicRankingResponse scoreTopUsers
     * @property {RankingUserList.$Properties|null} [scoreBorderUsers] UserVersusMusicRankingResponse scoreBorderUsers
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */

    /**
     * Properties of a UserVersusMusicRankingResponse.
     * @exports IUserVersusMusicRankingResponse
     * @interface IUserVersusMusicRankingResponse
     * @augments UserVersusMusicRankingResponse.$Properties
     * @deprecated Use UserVersusMusicRankingResponse.$Properties instead.
     */

    /**
     * Shape of a UserVersusMusicRankingResponse.
     * @typedef {UserVersusMusicRankingResponse.$Properties} UserVersusMusicRankingResponse.$Shape
     */

    /**
     * Constructs a new UserVersusMusicRankingResponse.
     * @exports UserVersusMusicRankingResponse
     * @classdesc Represents a UserVersusMusicRankingResponse.
     * @constructor
     * @param {UserVersusMusicRankingResponse.$Properties=} [p] Properties to set
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */
    const UserVersusMusicRankingResponse = function (p) {
        if (p)
            for (var ks = $Object.keys(p), i = 0; i < ks.length; ++i)
                if (p[ks[i]] != null && ks[i] !== "__proto__")
                    this[ks[i]] = p[ks[i]];
     ...
     * @memberof UserVersusMusicRankingResponse
     * @instance
     */
    UserVersusMusicRankingResponse.prototype.musicId = 0;
     ...
     * @instance
     */
    UserVersusMusicRankingResponse.prototype.scoreNearUsers = null;
     ...
     * @instance
     */
    UserVersusMusicRankingResponse.prototype.scoreTopUsers = null;
     ...
     * @instance
     */
    UserVersusMusicRankingResponse.prototype.scoreBorderUsers = null;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    UserVersusMusicRankingResponse.decode = function (r, l, z, q, g) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        if (q === $undefined)
            q = 0;
        if (q > $Reader.recursionLimit)
            throw $Error("max depth exceeded");
        var c = l === $undefined ? r.len : r.pos + l, m = g || new $root.UserVersusMusicRankingResponse(), v;
        while (r.pos < c) {
            var s = r.pos;
            var t = r.tag();
            if (t === z) {
    ...
    return UserVersusMusicRankingResponse;
})();
