 ...
 */
export interface IUserTeamLiveFestivalEventRankingResponse extends UserTeamLiveFestivalEventRankingResponse.$Properties {
}

/** Represents a UserTeamLiveFestivalEventRankingResponse. */
export class UserTeamLiveFestivalEventRankingResponse {

    /**
     * Constructs a new UserTeamLiveFestivalEventRankingResponse.
     * @param [p] Properties to set
     */
    constructor(p?: UserTeamLiveFestivalEventRankingResponse.$Properties);

    /** Unknown fields preserved while decoding when enabled */
    $unknowns?: Uint8Array[];

    /** UserTeamLiveFestivalEventRankingResponse nearUsers. */
    nearUsers?: (RankingUserList.$Properties|null);

    /** UserTeamLiveFestivalEventRankingResponse topUsers. */
    topUsers?: (RankingUserList.$Properties|null);
     ...
     */
    static decode(r: ($protobuf.Reader|Uint8Array), l?: number): UserTeamLiveFestivalEventRankingResponse & UserTeamLiveFestivalEventRankingResponse.$Shape;
}

export namespace UserTeamLiveFestivalEventRankingResponse {
    ...
    type $Shape = UserTeamLiveFestivalEventRankingResponse.$Properties;
}
