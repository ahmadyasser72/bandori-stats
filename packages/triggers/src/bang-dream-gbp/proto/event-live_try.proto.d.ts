 ...
 */
export interface IUserLiveTryEventRankingResponse extends UserLiveTryEventRankingResponse.$Properties {
}

/** Represents a UserLiveTryEventRankingResponse. */
export class UserLiveTryEventRankingResponse {

    /**
     * Constructs a new UserLiveTryEventRankingResponse.
     * @param [p] Properties to set
     */
    constructor(p?: UserLiveTryEventRankingResponse.$Properties);
     ...
     */
    static decode(r: ($protobuf.Reader|Uint8Array), l?: number): UserLiveTryEventRankingResponse & UserLiveTryEventRankingResponse.$Shape;
}

export namespace UserLiveTryEventRankingResponse {
    ...
    type $Shape = UserLiveTryEventRankingResponse.$Properties;
}
