...
export const UserChallengeEventRankingResponse = $root.UserChallengeEventRankingResponse = (() => {

    /**
     * Properties of a UserChallengeEventRankingResponse.
     * @typedef {Object} UserChallengeEventRankingResponse.$Properties
     * @property {RankingUserList.$Properties|null} [eventPointNearUsers] UserChallengeEventRankingResponse eventPointNearUsers
     * @property {RankingUserList.$Properties|null} [eventPointTopUsers] UserChallengeEventRankingResponse eventPointTopUsers
     * @property {RankingUserList.$Properties|null} [eventPointBorderUsers] UserChallengeEventRankingResponse eventPointBorderUsers
     * @property {Array.<UserChallengeMusicRankingResponse.$Properties>|null} [challengeMusicRankings] UserChallengeEventRankingResponse challengeMusicRankings
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */

    /**
     * Properties of a UserChallengeEventRankingResponse.
     * @exports IUserChallengeEventRankingResponse
     * @interface IUserChallengeEventRankingResponse
     * @augments UserChallengeEventRankingResponse.$Properties
     * @deprecated Use UserChallengeEventRankingResponse.$Properties instead.
     */

    /**
     * Shape of a UserChallengeEventRankingResponse.
     * @typedef {UserChallengeEventRankingResponse.$Properties} UserChallengeEventRankingResponse.$Shape
     */

    /**
     * Constructs a new UserChallengeEventRankingResponse.
     * @exports UserChallengeEventRankingResponse
     * @classdesc Represents a UserChallengeEventRankingResponse.
     * @constructor
     * @param {UserChallengeEventRankingResponse.$Properties=} [p] Properties to set
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */
    const UserChallengeEventRankingResponse = function (p) {
        this.challengeMusicRankings = [];
        if (p)
    ...
    /**
     * UserChallengeEventRankingResponse eventPointNearUsers.
     * @member {RankingUserList.$Properties|null|undefined} eventPointNearUsers
     * @memberof UserChallengeEventRankingResponse
     * @instance
     */
    UserChallengeEventRankingResponse.prototype.eventPointNearUsers = null;

    /**
     * UserChallengeEventRankingResponse eventPointTopUsers.
     * @member {RankingUserList.$Properties|null|undefined} eventPointTopUsers
     * @memberof UserChallengeEventRankingResponse
     * @instance
     */
    UserChallengeEventRankingResponse.prototype.eventPointTopUsers = null;

    /**
     * UserChallengeEventRankingResponse eventPointBorderUsers.
     * @member {RankingUserList.$Properties|null|undefined} eventPointBorderUsers
     * @memberof UserChallengeEventRankingResponse
     * @instance
     */
    UserChallengeEventRankingResponse.prototype.eventPointBorderUsers = null;

    /**
     * UserChallengeEventRankingResponse challengeMusicRankings.
     * @member {Array.<UserChallengeMusicRankingResponse.$Properties>} challengeMusicRankings
     * @memberof UserChallengeEventRankingResponse
     * @instance
     */
    UserChallengeEventRankingResponse.prototype.challengeMusicRankings = $util.emptyArray;

    /**
     * Decodes a UserChallengeEventRankingResponse message from the specified reader or buffer.
     * @function decode
     * @memberof UserChallengeEventRankingResponse
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {UserChallengeEventRankingResponse & UserChallengeEventRankingResponse.$Shape} UserChallengeEventRankingResponse
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    UserChallengeEventRankingResponse.decode = function (r, l, z, q, g) {
        ...
        var c = l === $undefined ? r.len : r.pos + l, m = g || new $root.UserChallengeEventRankingResponse(), v;
        while (r.pos < c) {
            var s = r.pos;
            var t = r.tag();
            if (t === z) {
            ...
            case 101: {
                    if (u !== 2)
                        break;
                    if (!(m.challengeMusicRankings && m.challengeMusicRankings.length))
                        m.challengeMusicRankings = [];
                    m.challengeMusicRankings.push($root.UserChallengeMusicRankingResponse.decode(r, r.uint32(), $undefined, q + 1));
                    continue;
                }
            }
            r.skipType(u, q, t);
    ...
    return UserChallengeEventRankingResponse;
})();
...
export const UserChallengeMusicRankingResponse = $root.UserChallengeMusicRankingResponse = (() => {

    /**
     * Properties of a UserChallengeMusicRankingResponse.
     * @typedef {Object} UserChallengeMusicRankingResponse.$Properties
     * @property {number|null} [musicId] UserChallengeMusicRankingResponse musicId
     * @property {RankingUserList.$Properties|null} [scoreNearUsers] UserChallengeMusicRankingResponse scoreNearUsers
     * @property {RankingUserList.$Properties|null} [scoreTopUsers] UserChallengeMusicRankingResponse scoreTopUsers
     * @property {RankingUserList.$Properties|null} [scoreBorderUsers] UserChallengeMusicRankingResponse scoreBorderUsers
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */

    /**
     * Properties of a UserChallengeMusicRankingResponse.
     * @exports IUserChallengeMusicRankingResponse
     * @interface IUserChallengeMusicRankingResponse
     * @augments UserChallengeMusicRankingResponse.$Properties
     * @deprecated Use UserChallengeMusicRankingResponse.$Properties instead.
     */

    /**
     * Shape of a UserChallengeMusicRankingResponse.
     * @typedef {UserChallengeMusicRankingResponse.$Properties} UserChallengeMusicRankingResponse.$Shape
     */

    /**
     * Constructs a new UserChallengeMusicRankingResponse.
     * @exports UserChallengeMusicRankingResponse
     * @classdesc Represents a UserChallengeMusicRankingResponse.
     * @constructor
     * @param {UserChallengeMusicRankingResponse.$Properties=} [p] Properties to set
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */
    const UserChallengeMusicRankingResponse = function (p) {
        if (p)
            for (var ks = $Object.keys(p), i = 0; i < ks.length; ++i)
                if (p[ks[i]] != null && ks[i] !== "__proto__")
                    this[ks[i]] = p[ks[i]];
    ...
    /**
     * UserChallengeMusicRankingResponse musicId.
     * @member {number} musicId
     * @memberof UserChallengeMusicRankingResponse
     * @instance
     */
    UserChallengeMusicRankingResponse.prototype.musicId = 0;

    /**
     * UserChallengeMusicRankingResponse scoreNearUsers.
     * @member {RankingUserList.$Properties|null|undefined} scoreNearUsers
     * @memberof UserChallengeMusicRankingResponse
     * @instance
     */
    UserChallengeMusicRankingResponse.prototype.scoreNearUsers = null;

    /**
     * UserChallengeMusicRankingResponse scoreTopUsers.
     * @member {RankingUserList.$Properties|null|undefined} scoreTopUsers
     * @memberof UserChallengeMusicRankingResponse
     * @instance
     */
    UserChallengeMusicRankingResponse.prototype.scoreTopUsers = null;

    /**
     * UserChallengeMusicRankingResponse scoreBorderUsers.
     * @member {RankingUserList.$Properties|null|undefined} scoreBorderUsers
     * @memberof UserChallengeMusicRankingResponse
     * @instance
     */
    UserChallengeMusicRankingResponse.prototype.scoreBorderUsers = null;

    /**
     * Decodes a UserChallengeMusicRankingResponse message from the specified reader or buffer.
     * @function decode
     * @memberof UserChallengeMusicRankingResponse
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {UserChallengeMusicRankingResponse & UserChallengeMusicRankingResponse.$Shape} UserChallengeMusicRankingResponse
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    UserChallengeMusicRankingResponse.decode = function (r, l, z, q, g) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        if (q === $undefined)
            q = 0;
        if (q > $Reader.recursionLimit)
            throw $Error("max depth exceeded");
        var c = l === $undefined ? r.len : r.pos + l, m = g || new $root.UserChallengeMusicRankingResponse(), v;
        while (r.pos < c) {
            var s = r.pos;
            var t = r.tag();
            if (t === z) {
    ...
    return UserChallengeMusicRankingResponse;
})();
