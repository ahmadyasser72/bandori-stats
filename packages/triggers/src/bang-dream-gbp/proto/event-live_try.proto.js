...
export const UserLiveTryEventRankingResponse = $root.UserLiveTryEventRankingResponse = (() => {

    /**
     * Properties of a UserLiveTryEventRankingResponse.
     * @typedef {Object} UserLiveTryEventRankingResponse.$Properties
     * @property {RankingUserList.$Properties|null} [nearUsers] UserLiveTryEventRankingResponse nearUsers
     * @property {RankingUserList.$Properties|null} [topUsers] UserLiveTryEventRankingResponse topUsers
     * @property {RankingUserList.$Properties|null} [eventPointBorderUsers] UserLiveTryEventRankingResponse eventPointBorderUsers
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */

    /**
     * Properties of a UserLiveTryEventRankingResponse.
     * @exports IUserLiveTryEventRankingResponse
     * @interface IUserLiveTryEventRankingResponse
     * @augments UserLiveTryEventRankingResponse.$Properties
     * @deprecated Use UserLiveTryEventRankingResponse.$Properties instead.
     */

    /**
     * Shape of a UserLiveTryEventRankingResponse.
     * @typedef {UserLiveTryEventRankingResponse.$Properties} UserLiveTryEventRankingResponse.$Shape
     */

    /**
     * Constructs a new UserLiveTryEventRankingResponse.
     * @exports UserLiveTryEventRankingResponse
     * @classdesc Represents a UserLiveTryEventRankingResponse.
     * @constructor
     * @param {UserLiveTryEventRankingResponse.$Properties=} [p] Properties to set
     * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
     */
    const UserLiveTryEventRankingResponse = function (p) {
        if (p)
    ...
    /**
     * UserLiveTryEventRankingResponse nearUsers.
     * @member {RankingUserList.$Properties|null|undefined} nearUsers
     * @memberof UserLiveTryEventRankingResponse
     * @instance
     */
    UserLiveTryEventRankingResponse.prototype.nearUsers = null;

    /**
     * UserLiveTryEventRankingResponse topUsers.
     * @member {RankingUserList.$Properties|null|undefined} topUsers
     * @memberof UserLiveTryEventRankingResponse
     * @instance
     */
    UserLiveTryEventRankingResponse.prototype.topUsers = null;

    /**
     * UserLiveTryEventRankingResponse eventPointBorderUsers.
     * @member {RankingUserList.$Properties|null|undefined} eventPointBorderUsers
     * @memberof UserLiveTryEventRankingResponse
     * @instance
     */
    UserLiveTryEventRankingResponse.prototype.eventPointBorderUsers = null;

    /**
     * Decodes a UserLiveTryEventRankingResponse message from the specified reader or buffer.
     * @function decode
     * @memberof UserLiveTryEventRankingResponse
     * @static
     * @param {$protobuf.Reader|Uint8Array} r Reader or buffer to decode from
     * @param {number} [l] Message length if known beforehand
     * @returns {UserLiveTryEventRankingResponse & UserLiveTryEventRankingResponse.$Shape} UserLiveTryEventRankingResponse
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    UserLiveTryEventRankingResponse.decode = function (r, l, z, q, g) {
        ...
        var c = l === $undefined ? r.len : r.pos + l, m = g || new $root.UserLiveTryEventRankingResponse(), v;
        while (r.pos < c) {
            var s = r.pos;
            var t = r.tag();
            if (t === z) {
    ...
    return UserLiveTryEventRankingResponse;
})();
