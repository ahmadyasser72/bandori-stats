 ...
 */
export interface IUserStoryEventRankingResponse extends UserStoryEventRankingResponse.$Properties {
}

/** Represents a UserStoryEventRankingResponse. */
export class UserStoryEventRankingResponse {

    /**
     * Constructs a new UserStoryEventRankingResponse.
     * @param [p] Properties to set
     */
    constructor(p?: UserStoryEventRankingResponse.$Properties);
     ...
     */
    static decode(r: ($protobuf.Reader|Uint8Array), l?: number): UserStoryEventRankingResponse & UserStoryEventRankingResponse.$Shape;
}

export namespace UserStoryEventRankingResponse {
    ...
    type $Shape = UserStoryEventRankingResponse.$Properties;
}
